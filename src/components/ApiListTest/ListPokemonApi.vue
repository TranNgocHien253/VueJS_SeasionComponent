            ...
            <tr>
              <th>
                <div class="thead">
                  No
                  <div class="sort">
                    <span @click="sortPokemons('number', 'desc')" class="sort-icon"><span
                        v-if="isVisibleAsc === true">▲</span></span>
                    <span @click="sortPokemons('number', 'asc')" class="sort-icon"><span
                        v-if="isVisibleDesc === true">▼</span></span>
                  </div>
                </div>
              </th>
              <th>Name
