          ...
          <div class="form-body">
            <div class="form-group-cha">
              ...
              <div class="form-group">
                ...
                <input id="name" type="text" class="inputModel" :value="pokemon.name" disabled />
              </div>
              <div class="form-group">
                <label for="total">Total:</label>
                <input id="total" type="text" class="inputModel" :value="pokemon.total" disabled />
              </div>
              <div class="form-group">
                <label for="hp">HP:</label>
                <input id="hp" type="text" class="inputModel" :value="pokemon.hp" disabled />
              </div>
              <div class="form-group">
                <label for="attack">Attack:</label>
                <input id="attack" type="text" class="inputModel" :value="pokemon.attack" disabled />
              </div>
              <div class="form-group">
                <label for="defense">Defense:</label>
                <input id="defense" type="text" class="inputModel" :value="pokemon.defense" disabled />
              </div>
              <div class="form-group">
                <label for="sp_atk">Sp Atk:</label>
                <input id="sp_atk" type="text" class="inputModel" :value="pokemon.sp_atk" disabled />
              </div>
              <div class="form-group">
                <label for="sp_def">Sp Defense:</label>
                <input id="sp_def" type="text" class="inputModel" :value="pokemon.sp_def" disabled />
              </div>
              <div class="form-group">
                <label for="speed">Speed:</label>
                <input id="speed" type="text" class="inputModel" :value="pokemon.speed" disabled />
              </div>
              <div class="form-group">
                <label for="created_at">Create At:</label>
                <input id="created_at" type="text" class="inputModel" :value="formatDate(pokemon.created_at)"
                  disabled />
              </div>
              <div class="form-group">
                <label for="updated_at">Update At:</label>
                <input id="updated_at" type="text" class="inputModel" :value="formatDate(pokemon.updated_at)"
                  disabled />
              </div>
            </div>
